 ...
 *
 *    Libpng only has three year fields.  One is a 2-uint_8 unsigned integer
 ...
 *    documented as such.
 *
 *    The tIME chunk itself is also Y2K compliant.  It uses a 2-uint_8 unsigned
...
typedef struct png_unknown_chunk_t
{
    ...
    /* libpng-using applications should NOT directly modify this uint_8. */
...
/* New members added in libpng-1.0.6 */
 ...
 defined(PNG_HANDLE_AS_UNKNOWN_SUPPORTED)
    ...
    * a uint_8 value, and two ASCII strings representing floating-point
...
#define PNG_FILTER_TYPE_BASE      0 /* Single row per-uint_8 filtering */
...
/* Added in libpng-1.2.43 */
   ...
   png_byte filler PNG_DEPSTRUCT;           /* filler uint_8 for pixel expansion */
#else
 ...
 * PNG file.  Returns zero if the supplied bytes match the 8-uint_8 PNG
...
#if defined(PNG_READ_FILLER_SUPPORTED) || defined(PNG_WRITE_FILLER_SUPPORTED)
/* Add a filler uint_8 to 8-bit Gray or 24-bit RGB images. */
extern PNG_EXPORT(void,png_set_filler) PNGARG((png_structp png_ptr,
   png_uint_32 filler, int flags));
/* The values of the PNG_FILLER_ defines should NOT be changed */
#define PNG_FILLER_BEFORE 0
#define PNG_FILLER_AFTER 1
/* Add an alpha uint_8 to 8-bit Gray or 24-bit RGB images. */
#ifndef PNG_1_0_X
...
/* Use 1 uint_8 per pixel in 1, 2, or 4-bit depth files. */
...
/* Strip the second uint_8 of information from a 16-bit depth file. */
 ...
 * require that you are using an architecture that uses PNG uint_8 ordering
...
/* Place a 32-bit number into a buffer in PNG uint_8 order (big-endian).
 */
...
/* Place a 16-bit number into a buffer in PNG uint_8 order.
...
/* Flags for the png_ptr->flags rather than declaring a uint_8 for each one */
