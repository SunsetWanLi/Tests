...
#endif //WITH_NONAMESPACES add by GRF for multiple wsdl
...
# define SOAP_SOCKLEN_T SOCKLEN_T
#elif defined(__socklen_t_defined) || defined(_SOCKLEN_T) || defined(CYGWIN) || defined(FREEBSD) || defined(__FreeBSD__) || defined(OPENBSD) || defined(__QNX__) || defined(QNX) || defined(OS390) || defined(HP_UX) ||defined(ANDROID_NDK)
# define SOAP_SOCKLEN_T socklen_t
