...
/* Place a 32-bit number into a buffer in PNG uint_8 order.  We work
...
png_write_sig(png_structp png_ptr)
{
   ...
   /* Write the rest of the 8 uint_8 signature */
    ...
    png_charp lang, png_charp lang_key, png_charp text)
{
   ...
   /* Make sure we include the compression flag, the compression uint_8,
    * and the NULs after the key, lang, and lang_key parts */

   png_write_chunk_start(png_ptr, (png_bytep)png_iTXt,
          (png_uint_32)(
        5 /* comp uint_8, comp flag, terminators for key, lang and lang_key */
        + key_len
        + lang_len
        + lang_key_len
        + text_len));
