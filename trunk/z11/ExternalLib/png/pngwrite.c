...
png_write_row(png_structp png_ptr, png_bytep row)
{
   ...
   /* Copy user's row into buffer, leaving room for filter uint_8. */
...
#ifndef WBITS_8_OK
   /* Avoid libpng bug with 256-uint_8 windows */
   if (window_bits == 8)
     {
              ...
              int transforms, voidp params)
{
   ...
   /* Swap bytes of 16-bit files to most significant uint_8 first */
