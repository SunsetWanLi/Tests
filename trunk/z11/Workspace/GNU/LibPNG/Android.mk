...
LOCAL_ARM_MODE := arm
LOCAL_PATH =	$(Z11_PATH)/ExternalLib/png
...
common_CFLAGS := -fvisibility=hidden -DPNG_FLOATING_POINT_SUPPORTED -mfpu=vfpv3-d16 -mfloat-abi=softfp -O3 -funroll-loops -fomit-frame-pointer -ffast-math ## -fomit-frame-pointer
